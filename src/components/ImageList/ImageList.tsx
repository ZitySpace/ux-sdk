...
const ImageList = () => {
  ...
  return (
    <>
      <div className='bg-gray-100 absolute max-h-full max-w-full flex flex-col text-xs shadow-lg rounded-md select-none'>
        <div className='bg-indigo-400 py-2 px-2 rounded-t-md flex justify-center space-x-2'>
          <span>Image List</span>
        </div>
        <div className='resize overflow-auto w-56 xs:w-72 md:w-96 h-64 xl:h-96 max-w-full px-4 py-2 flex flex-col space-y-2'>
